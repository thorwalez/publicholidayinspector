 ...
 */
class AllSaintsDay extends EasterSunday
{
    const FIX_PUBLIC_HOLIDAY_ALL_SAINTS_DAY      = '01.11';

    const DAY_NAME = PublicHolidaysConstantsInterface::PUBLIC_HOLIDAY_NAME_ALL_SAINTS_DAY;
    ...
    {
        return $changeDate == self::FIX_PUBLIC_HOLIDAY_ALL_SAINTS_DAY;
    }
}