 ...
 */
class StaatHoliday extends EasterSunday
{
    const FIX_PUBLIC_HOLIDAY_STAAT_HOLIDAY     = '01.05';

    const DAY_NAME = PublicHolidaysConstantsInterface::PUBLIC_HOLIDAY_NAME_STAAT_HOLIDAY;
    ...
    {
        return $changeDate == self::FIX_PUBLIC_HOLIDAY_STAAT_HOLIDAY;
    }
}