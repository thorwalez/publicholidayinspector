 ...
 */
class LaborDay extends EasterSunday
{
    const FIX_PUBLIC_HOLIDAY_LABOR_DAY = '01.05';
    const DAY_NAME = PublicHolidaysConstantsInterface::PUBLIC_HOLIDAY_NAME_LABOR_DAY;
    ...
    {
        return $changeDate == self::FIX_PUBLIC_HOLIDAY_LABOR_DAY;
    }
